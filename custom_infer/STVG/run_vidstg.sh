...
# bash custom_infer/STVG/run_vidstg.sh 
# ===================================== Qwen2_VL ===================================== 
# idx=-3
# frames_thre=5
# cfg='custom_infer/STVG/experiments/vidstg.yaml'
# split='test'
...
#     --img_size 224 \
#     --token_idx ${idx} \
#     --exp_comment "_token_${idx}_0.3_0.48" \
...
PYTHONPATH="$PWD" CUDA_VISIBLE_DEVICES=0 python3 custom_infer/STVG/hc_internvl2_5.py \
    ...
    --token_idx ${idx} \
    --exp_comment "_token_${idx}" \
    INPUT.SAMPLE_FRAMES 8 \
    INPUT.RESOLUTION 448

# bash custom_infer/STVG/run_vidstg.sh model_zoo/LLaVA-NeXT-Video-7B-DPO vicuna_v1 30 4 average no_token True "hhh.mp4"
