...
from custom_infer.STVG.V_Tuning.spatial_tuning import spatial_llm_logit, spatial_llm_att, spatial_llm_reverse_logit, spatial_llm_att_w_reverse
...
def llava_embedd_tuning(cfg_pretrained, tokenizer, model, image_processor, video, questions, grid_size, targets, args, vid_i, logger):
    ...
    if llm_reasoning:
        ...
        # llava_att_pred_track_id_pre_tuning, llava_rela_att_pre_tuning, max_att_each_proposal_pre_tuning = spatial_llm_att(
        #                                         model,
        #                                         tmp_questions.copy(),
        ...
        npy_f = f'custom_infer/STVG/output/hcstvg1/llava_next_video_7b_f_20/focus_attr_ep_2_lr_8.0_0.0_token_-5_(vp_tuning)_(attr_cap_attr_cap)/_llava_att_npy/{name_f}.npy'
        ...
        # ============== load llava_rela_att
        npy_f = f'custom_infer/STVG/output/hcstvg1/llava_next_video_7b_ablation_pred_frames/f_20_Pre_5_focus_act_ep_2_lr_8.0_8.0_token_-5/_llava_att_npy/{name_f}.npy'
        llava_dict = np.load(npy_f, allow_pickle=True).item()
