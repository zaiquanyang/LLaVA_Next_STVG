...
from custom_infer.vis import show_image_relevance, show_video_relevance, norm_video_att, original_resize_336, blur_proposal_video_array, blur_video_frames
...
from custom_infer.STVG.V_Tuning.spatial_tuning import spatial_llm_logit, spatial_llm_att, temporal_logit_w_reverse
...
def llava_embedd_tuning(cfg_pretrained, tokenizer, model, image_processor, video, questions, grid_size, targets, args, vid_i, logger):
    ...
    if llm_reasoning:
        ...
        if args.ttt_epoch > 0:
            ...
            spatial_prompt, spatial_prompt_history = temporal_logit_w_reverse(
                                                    model,
                                                    tmp_questions.copy(), 
