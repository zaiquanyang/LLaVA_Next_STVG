...
def llava_embedd_tuning(cfg_pretrained, tokenizer, model, processor, video, questions, grid_size, targets, args, vid_i, logger):
    ...
    if llm_reasoning:
        ...
        npy_f = f'custom_infer/STVG/output/hcstvg2/qwen2_vl_7b_f_20/focus_attr_ep_2_lr_8.0_8.0_token_-3/_llava_att_npy/{name_f}.npy'
        ...
        # ============== load llava_rela_att
        npy_f = f'custom_infer/STVG/output/hcstvg2/qwen2_vl_7b_f_20/focus_act_ep_2_lr_8.0_8.0_token_-3_(act_cap)/_llava_att_npy/{name_f}.npy'
        llava_dict = np.load(npy_f, allow_pickle=True).item()
