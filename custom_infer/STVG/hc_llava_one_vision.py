...
def run_inference(args):
    ...
    exp_name = f"{args.dataset_name}/{model_name}_f_{cfg.INPUT.SAMPLE_FRAMES}_Refine_0430/{args.llm_infer_mode}_ep_{args.ttt_epoch}_lr_{args.s_lr}_{args.t_lr}{args.exp_comment}"
    ...
    writer = SummaryWriter(f'{output_dir}/_thre_{args.frames_thre}_f_in_track')
    ...
    # with open("custom_infer/STVG/output/decomp_yes_1k.json", "r", encoding="utf-8") as f:
    ...
    for vid_i in range(len(vid_dataset)):
        ...
        # if vid_i > 1000:
        #     break
        # if vid_i not in vid_names_w_better_track:
        #     continue
