...
base = importlib.import_module("custom_infer.STVG.InternVL_Tuning.st_tuning_base")
focus_attr = importlib.import_module("custom_infer.STVG.InternVL_Tuning.st_tuning_focus_attr")
...
def run_inference(args):
    ...
    path = '/home/zaiquyang2/scratch/mllm/LLaVA-NeXT/model_zoo/InternVL2_5-4B'
    ...
    # default processer
    image_processor = None# AutoProcessor.from_pretrained("Qwen/Qwen2-VL-7B-Instruct")
    tokenizer = AutoTokenizer.from_pretrained(path, trust_remote_code=True, use_fast=False)
    ...
    for vid_i in range(len(vid_dataset)):
        ...
        try:
            ...
            # breakpoint()
            bbox_pred_tmp, temporal_pred_tmp, hit_token_id = st_tuning_module.llava_embedd_tuning(
                                                            tokenizer=tokenizer,
                                                            cfg_pretrained=None, 
                                                            model=model, 
