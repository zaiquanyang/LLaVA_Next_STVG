...
from custom_infer.STVG.Sharegpt4video.ShareGPT4Video.llava.model.builder import load_pretrained_model
...
base = importlib.import_module("custom_infer.STVG.Sharegpt4video.st_tuning_base")
focus_attr = importlib.import_module("custom_infer.STVG.Sharegpt4video.st_tuning_focus_attr")
# focus_attr_w_reverse = importlib.import_module("custom_infer.STVG.V_Tuning.st_tuning_focus_attr_w_reverse")
focus_act = importlib.import_module("custom_infer.STVG.Sharegpt4video.st_tuning_focus_act")
focus_whole = importlib.import_module("custom_infer.STVG.Sharegpt4video.st_tuning_focus_whole")
...
def run_inference(args):
    ...
    model_path = "/home/zaiquyang2/scratch/mllm/LLaVA-NeXT/model_zoo/sharegpt4video-8b"
    model_name = 'sharegpt4video-8b-debug'

    tokenizer, model, image_processor, context_len = load_pretrained_model(model_path, None, model_name, device_map='cpu')
