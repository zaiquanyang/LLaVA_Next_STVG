...
# from custom_infer.utils import load_video, load_video_base64, Q_to_prompt, llava_embedd_infer, load_img_list#, llava_embedd_tuning
# from custom_infer.vis import show_image_relevance, show_video_relevance, norm_video_att, original_resize_336, plot_stvg_metrics
...
focus_sub_act = importlib.import_module("custom_infer.STVG.V_Tuning.st_tuning_focus_sub_act")
focus_act_w_reverse = importlib.import_module("custom_infer.STVG.V_Tuning.st_tuning_focus_act_w_reverse")
...
st_tuning.append(focus_sub_act)
st_tuning.append(focus_act_w_reverse)
...
infer_module_name.append(focus_sub_act.__name__.split('.')[-1][10:])
infer_module_name.append(focus_act_w_reverse.__name__.split('.')[-1][10:])
...
def run_inference(args):
    ...
    # exp_name = f"{args.dataset_name}/{model_name}_f_{cfg.INPUT.SAMPLE_FRAMES}_ablation_frames/{args.llm_infer_mode}_ep_{args.ttt_epoch}_lr_{args.s_lr}_{args.t_lr}{args.exp_comment}"
    exp_name = f"{args.dataset_name}/{model_name}_ablation_pred_frames/f_{cfg.INPUT.SAMPLE_FRAMES}_Pre_{args.frames_thre}_{args.llm_infer_mode}_ep_{args.ttt_epoch}_lr_{args.s_lr}_{args.t_lr}{args.exp_comment}"
