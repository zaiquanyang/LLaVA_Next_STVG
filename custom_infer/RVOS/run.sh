...
PYTHONPATH="$PWD" CUDA_VISIBLE_DEVICES=1 python3 custom_infer/RVOS/vos_infer.py \
    --model-path $CKPT \
...
# bash custom_infer/RVOS/run.sh model_zoo/LLaVA-NeXT-Video-7B-DPO vicuna_v1 30 4 average no_token True "hhh.mp4"